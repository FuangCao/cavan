...
ifeq ($(CAVAN_NDK_BUILD),true)
CAVAN_CFLAGS += -DCONFIG_ANDROID_NDK
...
ifdef LOCAL_OBJS_DIR
CAVAN_OUT_PATH := $(LOCAL_OBJS_DIR)
else
...
$(CAVAN_OUT_PATH)/app/%.o $(CAVAN_OUT_PATH)/android/command/%.o: PRIVATE_CFLAGS += -Dmain=do_cavan_$(basename $(notdir $@))
$(CAVAN_OUT_PATH)/app/core/%.o: PRIVATE_CFLAGS += -Umain -I$(CAVAN_OUT_PATH)
