...
PATH := $(PATH):$(SYSROOT_APPS):$(UTILS_APPS)
...
$(MARK_EMULATOR_READY): $(MARK_UTILS_READY)
...
build_env:
	$(Q)mkdir $(SRC_PATH) $(SYSROOT_PATH) $(ROOTFS_PATH) $(UTILS_PATH) $(OUT_UTILS) $(OUT_TOOLCHIAN) $(OUT_EMULATOR) $(OUT_ROOTFS) $(OUT_LIBRARY) $(DECOMP_PATH) $(DOWNLOAD_PATH) -pv
