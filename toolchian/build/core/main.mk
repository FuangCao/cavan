...
export OUT_PATH OUT_UTILS OUT_TOOLCHIAN OUT_ROOTFS OUT_LIBRARY
export BUILD_CORE BUILD_TOOLCHIAN BUILD_ROOTFS BUILD_LIBRARY BUILD_UTILS
export MARK_PATH MARK_TOOLCHIAN MARK_ROOTFS MARK_LIBRARY MARK_UTILS
export MARK_TOOLCHIAN_READY MARK_ROOTFS_READY MARK_LIBRARY_READY MARK_UTILS_READY
...
$(MARK_ROOTFS_READY): $(MARK_LIBRARY_READY)
...
build_env:
	$(Q)mkdir $(SRC_PATH) $(SYSROOT_PATH) $(ROOTFS_PATH) $(UTILS_PATH) $(OUT_UTILS) $(OUT_TOOLCHIAN) $(OUT_ROOTFS) $(OUT_LIBRARY) $(DECOMP_PATH) $(DOWNLOAD_PATH) -pv
	$(Q)mkdir $(MARK_TOOLCHIAN) $(MARK_ROOTFS) $(MARK_LIBRARY) $(MARK_UTILS) -pv
