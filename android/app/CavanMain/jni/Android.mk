...
CAVAN_NATIVE_C := $(CAVAN_PROJECT_PATH)/jni/$(CAVAN_NATIVE_NAME).c
...
LOCAL_C_INCLUDES := $(CAVAN_C_INCLUDES)
LOCAL_SRC_FILES := $(CAVAN_PROJECT_PATH)/jni/CavanMain.c $(CAVAN_NATIVE_C) $(CAVAN_LIB_SRC_FILES)
...
$(LOCAL_PATH)/$(CAVAN_NATIVE_C): $(addprefix $(LOCAL_PATH)/,$(CAVAN_APP_SRC_FILES)) $(CAVAN_NATIVE_JAVA) | $(CAVAN_OUT_PATH)
	$(hide) echo "Automatically generate $@"
	$(hide) { \
		...
		do \
			...
			echo; \
			echo "JNIEXPORT jint Java_$(CAVAN_NATIVE_NAME)_native$${native_app}(JNIEnv *env, jclass clazz, jobjectArray args)"; \
			echo "{"; \
