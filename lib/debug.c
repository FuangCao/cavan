...
const char *cavan_help_message_ip = "service ip address";
const char *cavan_help_message_hostname = "service hostname";
...
const char *cavan_help_message_port = "set service port";
